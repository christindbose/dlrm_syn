...
DLRM_SYSTEMS=/home/tgrogers-raid/a/chris241/DLRM/dlrm_syn/dlrm
MODELS_PATH=/home/tgrogers-raid/a/chris241/DLRM/dlrm_syn/dlrm
...
for e in $EMBS; do
    ...
    DATA_GEN="prod,$DLRM_SYSTEMS/datasets/reuse_$REUSE_LEVEL/table_500K.txt,$EMB_ROW"

    python3.7 dlrm_s_uvm_pytorch.py --data-generation=$DATA_GEN --round-targets=True --learning-rate=1.0 --arch-mlp-bot=$BOT_MLP --arch-mlp-top=$TOP_MLP --arch-sparse-feature-size=$EMB_DIM --max-ind-range=40000000 \
